...
test_that("score.Normal works as expected", {
    ...
    d <- Uniform(c(0.2, 0.4, 0.6), c(0.5, 1, 2))
    x <- c(0.4, 0.1, 0.8)
    ...
    ## Step function, numeric approximation of score not possible with
    ## score.distribution but also not required, comparison skipped.
