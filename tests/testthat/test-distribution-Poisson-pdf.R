...
#
# Prototype "PDF" which only requires the following:
#
...
registerS3method("pdf",         "MyPoissonPDF", getS3method("pdf",         class = "Poisson"))
...
test_that("cdf.distribution (approximation) comparing MyPoissonPDF and Poisson", {
    x <- 0:30
