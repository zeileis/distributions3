...
#
# - Constructor function ('MyPoissonQuantileCDF')
...
## Constructor function for new 'MyPoissonQuantileCDF' distribution
MyPoissonQuantileCDF <- function(lambda) {
    d <- data.frame(lambda = lambda)
    class(d) <- c("MyPoissonQuantileCDF", "distribution")
    return(d)
}

## The registration is required to work with testthat
registerS3method("quantile",    "MyPoissonQuantileCDF", getS3method("quantile",    class = "Poisson"))
registerS3method("cdf",         "MyPoissonQuantileCDF", getS3method("cdf",    class = "Poisson"))
registerS3method("is_discrete", "MyPoissonQuantileCDF", getS3method("is_discrete", class = "Poisson"))
registerS3method("support",     "MyPoissonQuantileCDF", getS3method("support",     class = "Poisson"))

## Distribution to test on
lambda <- c(0.5, 1, 4, 20)
expect_silent(d <- Poisson(lambda)) # Analytic version
expect_silent(n <- MyPoissonQuantileCDF(lambda)) # Minimal prototype
...
# Testing moments
# -------------------------------------------------------------------
test_that("mean.distribution (approximation) comparing MyPoissonQuantileCDF and Poisson", {
...
test_that("variance.distribution (approximation) comparing MyPoissonQuantileCDF and Poisson", {
...
test_that("skewness.distribution (approximation) comparing MyPoissonQuantileCDF and Poisson", {
...
test_that("kurtosis.distribution (approximation) comparing MyPoissonQuantileCDF and Poisson", {
...
# -------------------------------------------------------------------
d <- Poisson(3.2)
n <- MyPoissonQuantileCDF(3.2)


test_that("pdf.distribution (approximation) comparing MyPoissonQuantileCDF and Poisson", {
    x <- 0:30
...
test_that("cdf.distribution (approximation) comparing MyPoissonQuantileCDF and Poisson", {
    x <- 0:30
...
test_that("quantile.distribution (approximation) comparing MyPoissonQuantileCDF and Poisson", {
...
test_that("random.distribution (approximation) comparing MyPoissonQuantileCDF and Poisson", {
    set.seed(1)
