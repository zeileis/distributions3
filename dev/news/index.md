...
- Start working on new development version with additions by Reto
  [@retostauffer](https://github.com/retostauffer) especially for
  numerical approximations of various distribution functions.
...
- Enabled the inclusion of `distribution` vectors as columns in `tibble`
  data objects, see
  [`?vec_proxy.distribution`](https://zeileis.github.io/distributions3/dev/reference/vec_proxy.distribution.md)
